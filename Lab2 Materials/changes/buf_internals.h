...
typedef struct BufferDesc
{
	...
	//Making the MRUPrevious and MRUNext fields for the linked list
	int MRUPrevious;
	int MRUNext;
	//making timestamp buffer field
	int lastused;
...
extern void addtoMRUQueue(volatile BufferDesc *buffer);
extern void removefromMRUQueue(volatile BufferDesc *buffer);
