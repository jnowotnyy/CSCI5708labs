...
//uses these
//outerPlanState(Node node) from line 1035 of execNodes.h
//expression_returns_set(Node* clause) from line 44 of nodeFuncs.h

/** @brief  Pass offset bound to child nodes in several situations.
 * 
